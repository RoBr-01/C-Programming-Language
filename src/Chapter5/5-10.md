...
**Exercise 5-11.** Modify the program `entab` and `detab` (written as exercises in [Chapter 1](../Chapter1/1-0.md)) to accept a list of tab stops as arguments. Use the default tab settings if there are no arguments.
